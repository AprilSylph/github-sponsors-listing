...
2. Enable Actions in your fork:
   - Go to your fork's **Settings** &rarr; **Code and automation** &rarr;
     **Actions** &rarr; **General**
...
4. Add the Personal Access Token as a secret in your fork:
   - Go to your fork's **Settings** &rarr; **Security** &rarr; **Secrets and
...
- All done! A link to your published GitHub Pages site should appear in the
  action summary.

Be sure to visit the published GitHub Pages site to see what data is available
there.
...
To unpublish the data, go to your fork's **Settings** &rarr; **Pages** and click
"Unpublish site".
